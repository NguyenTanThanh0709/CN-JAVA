...
<body>
	<form method="post" action="<c:url value = '/RegisterController' />">
		<table>
			<tr>
				<td>Your Name</td>
			...
			<tr>
				...
				<td>
					<div>
						<input type="checkbox" name="favorite_ide"
							value="Visual Studio Code"> Visual Studio Code
					</div>
					<div>
						<input type="checkbox" name="favorite_ide" value="Sublime Text">
						Sublime Text
					</div>
					<div>
						<input type="checkbox" name="favorite_ide" value="Eclipse">
						Eclipse
					</div>
					<div>
						<input type="checkbox" name="favorite_ide" value="Atom">
						Atom
					</div>
					<div>
						<input type="checkbox" name="favorite_ide" value="Intelij Idea">
						Intelij Idea
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td><textarea name="message" rows="5" style="width: 200px"></textarea>
				</td>
			</tr>
			<tr>
				<td></td>
