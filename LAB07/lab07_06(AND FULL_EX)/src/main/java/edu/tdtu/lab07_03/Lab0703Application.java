...
public class Lab0703Application {
	...
	public CommandLineRunner commandLineRunner(){
		return args -> {
			...
			Collection<Student> list_5a = service.getAge(5);
			for (Student student : list_5a) {
				System.out.println(student);
			}

			Collection<Student> list_5b = service.getIeltsScore(5.0);
			for (Student student : list_5b) {
				System.out.println(student);
			}

			Collection<Student> list_5c = service.getName("thanh");
			for (Student student : list_5c) {
				System.out.println(student);
			}

			System.out.println(" ex6 ----------------");

			Iterable<Student> result = service.getAllStudents();
			for (Student student : result) {
				System.out.println(student);
			}

			Iterable<Student> result6 = service.getCustomeStudent();
			for (Student student : result6) {
				System.out.println(student);
			}
